    ...
    private void btnAdicionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAdicionarActionPerformed
        try {
            ...
            if (!txtGrado.getText().isEmpty()) {
                ...
                if (grad < 0 || grad > 127) {
                    JOptionPane.showMessageDialog(this, "El grado debe estar entre 0 y 127", "Error", JOptionPane.ERROR_MESSAGE);
                    return;
                }
                grado = (byte) grad;
            }
            ...
            if (RC.create(nuevo)) {
                JOptionPane.showMessageDialog(this, "Constituyente adicionado correctamente", "Éxito", JOptionPane.INFORMATION_MESSAGE);
                listar();
                limpiarCampos();
            } else {
                JOptionPane.showMessageDialog(this, "Error al adicionar el constituyente", "Error", JOptionPane.ERROR_MESSAGE);
            }
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        try {
            if (txtCodigo.getText().isEmpty()) {
                JOptionPane.showMessageDialog(this, "Seleccione un constituyente primero", "Error", JOptionPane.ERROR_MESSAGE);
                return;
            }
            ...
            if (RC.update(actualizado)) {
                JOptionPane.showMessageDialog(this, "Constituyente actualizado correctamente", "Éxito", JOptionPane.INFORMATION_MESSAGE);
                listar();
                limpiarCampos();
            } else {
                JOptionPane.showMessageDialog(this, "Error al actualizar el constituyente", "Error", JOptionPane.ERROR_MESSAGE);
            }
        } catch (NumberFormatException e) {
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        try {
            ...
            if (validator.existsInTable("RESIDUO_CONSTITUYENTE", "ConsCod", codigo)) {
                JOptionPane.showMessageDialog(this, "No se puede eliminar: El constituyente está siendo usado", "Error", JOptionPane.ERROR_MESSAGE);
                return;
            }
            ...
            if (confirm == JOptionPane.YES_OPTION) {
                if (RC.delete(codigo)) {
                    JOptionPane.showMessageDialog(this, "Constituyente eliminado correctamente", "Éxito", JOptionPane.INFORMATION_MESSAGE);
                    listar();
                    limpiarCampos();
                } else {
                    JOptionPane.showMessageDialog(this, "Error al eliminar el constituyente", "Error", JOptionPane.ERROR_MESSAGE);
                }
            }
        } catch (NumberFormatException e) {
