...
public class InformacionTrasladoResiduo extends javax.swing.JFrame {
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txtTransportista, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnAdicionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAdicionarActionPerformed
        try {
            ...
            if (RT.create(nuevo)) {
                JOptionPane.showMessageDialog(this, "Traslado adicionado correctamente", "Éxito", JOptionPane.INFORMATION_MESSAGE);
                listar();
                limpiarCampos();
            } else {
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        try {
            ...
            if (RT.update(actualizado)) {
                JOptionPane.showMessageDialog(this, "Traslado actualizado correctamente", "Éxito", JOptionPane.INFORMATION_MESSAGE);
                listar();
                limpiarCampos();
            } else {
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        try {
            ...
            if (confirm == JOptionPane.YES_OPTION) {
                if (RT.delete(codigo)) {
                    JOptionPane.showMessageDialog(this, "Traslado eliminado correctamente", "Éxito", JOptionPane.INFORMATION_MESSAGE);
                    listar();
                    limpiarCampos();
                } else {
    ...
    private void tblTrasladosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblTrasladosMouseClicked
        ...
        if (fila >= 0) {
            txtCodigo.setText(tblTraslados.getValueAt(fila, 0).toString());
            ...
            txtResiduo.setText(tblTraslados.getValueAt(fila, 4).toString());
            txtEmpresa.setText(tblTraslados.getValueAt(fila, 5).toString());
            txtTransportista.setText(tblTraslados.getValueAt(fila, 6).toString());
            txtDestino.setText(tblTraslados.getValueAt(fila, 7).toString());
        }
