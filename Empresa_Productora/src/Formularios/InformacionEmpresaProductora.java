...
import Registro.RegistroEmpresaProductora;
import Registro.EmpresaProductora;
...
public class InformacionEmpresaProductora extends javax.swing.JFrame {
    private final RegistroEmpresaProductora REP;
    private final ResiduosToxicosValidator validator;
    private final Connection con;
    
    public InformacionEmpresaProductora() {
        initComponents();
        con = Conexion.getConnection();
        validator = new ResiduosToxicosValidator(con);
        REP = new RegistroEmpresaProductora();
        listar();
        this.setLocationRelativeTo(null);
    }
    
    private void listar() {
        tblEmpresas.setModel(REP.getDatos());
    }
    ...
    private void initComponents() {
        ...
        setTitle("Gestión de Empresas Productoras");

        jPanel1.setBackground(new java.awt.Color(102, 0, 153));

        jLabel1.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setText("Gestión de Empresas Productoras");
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Datos de la Empresa Productora"));
        ...
        jLabel8.setText("Empresas Productoras Registradas:");

        tblEmpresas.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {},
            new String [] {
                "Código", "Nombre", "RUC", "Dirección", "Actividad", "Región"
            }
        ) {
    ...
    private void btnAdicionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAdicionarActionPerformed
        try {
            ...
            if (actividad.length() > 100) {
                JOptionPane.showMessageDialog(this, "Actividad demasiado larga (máx. 100 caracteres)", "Error", JOptionPane.ERROR_MESSAGE);
                return;
            }
            ...
            EmpresaProductora nueva = new EmpresaProductora();
            nueva.setEmpNom(nombre);
            nueva.setEmpRUC(ruc);
            nueva.setEmpDir(direccion);
            nueva.setEmpAct(actividad.isEmpty() ? null : actividad);
            nueva.setRegCod(regCod);
            
            if (REP.create(nueva)) {
                JOptionPane.showMessageDialog(this, "Empresa adicionada correctamente", "Éxito", JOptionPane.INFORMATION_MESSAGE);
                listar();
                limpiarCampos();
            } else {
                JOptionPane.showMessageDialog(this, "Error al adicionar la empresa", "Error", JOptionPane.ERROR_MESSAGE);
            }
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        try {
            ...
            EmpresaProductora actualizada = new EmpresaProductora();
            actualizada.setEmpCod(codigo);
            actualizada.setEmpNom(nombre);
            actualizada.setEmpRUC(ruc);
            actualizada.setEmpDir(direccion);
            actualizada.setEmpAct(actividad.isEmpty() ? null : actividad);
            actualizada.setRegCod(regCod);
            
            if (REP.update(actualizada)) {
                JOptionPane.showMessageDialog(this, "Empresa actualizada correctamente", "Éxito", JOptionPane.INFORMATION_MESSAGE);
                listar();
                limpiarCampos();
            } else {
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        try {
            ...
            if (validator.existsInTable("RESIDUO", "EmpCod", codigo) || 
                validator.existsInTable("TRASLADO_RESIDUO", "EmpCod", codigo)) {
                JOptionPane.showMessageDialog(this, "No se puede eliminar: La empresa está siendo utilizada", "Error", JOptionPane.ERROR_MESSAGE);
                return;
            }
            ...
            if (confirm == JOptionPane.YES_OPTION) {
                if (REP.delete(codigo)) {
                    JOptionPane.showMessageDialog(this, "Empresa eliminada correctamente", "Éxito", JOptionPane.INFORMATION_MESSAGE);
                    listar();
                    limpiarCampos();
                } else {
    ...
    private void tblEmpresasMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblEmpresasMouseClicked
        ...
        if (fila >= 0) {
            ...
            if (tblEmpresas.getValueAt(fila, 4) != null) {
                txtActividad.setText(tblEmpresas.getValueAt(fila, 4).toString());
            } else {
                txtActividad.setText("");
            }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            new InformacionEmpresaProductora().setVisible(true);
        });
    }
